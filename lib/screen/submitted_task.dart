...
class submitted_task extends StatefulWidget {
  @override
  State<submitted_task> createState() => _submitted_taskState();
}

class _submitted_taskState extends State<submitted_task> {
  List userList = [];
  late Timer time;
  ...
  void initState() {
    time = Timer.periodic(
        Duration(milliseconds: 500), (time) => sendEmpId('submit'));
